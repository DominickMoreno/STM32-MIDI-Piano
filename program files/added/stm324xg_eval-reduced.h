...
#define LED1_PIN                         0	//!!wmh todo GPIO_Pin_6
#define LED1_GPIO_PORT                   0	//!!wmh todo GPIOG
#define LED1_GPIO_CLK                    RCC_AHB1Periph_GPIOG  
  
#define LED2_PIN                         0	//!!wmh todo GPIO_Pin_8
#define LED2_GPIO_PORT                   0	//!!wmh todo GPIOG
#define LED2_GPIO_CLK                    RCC_AHB1Periph_GPIOG  
  
#define LED3_PIN                         0	//!!wmh todo GPIO_Pin_9
#define LED3_GPIO_PORT                   0	//!!wmh todo GPIOI
#define LED3_GPIO_CLK                    RCC_AHB1Periph_GPIOI  
  
#define LED4_PIN                         0	//!!wmh todo GPIO_Pin_7
#define LED4_GPIO_PORT                   0	//!!wmh todo GPIOC
